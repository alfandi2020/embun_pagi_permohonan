                    ...
                    <div class="row container mt-2">
                        <form class="col-md-2" action="<?= base_url('laporan/filter') ?>" method="POST">
                            ...
                            <select name="tahun" id="" class="form-control" onchange="form.submit()">
                                ...
                                <option <?= $this->session->userdata('filterTahun') == date('Y')-2 ? 'selected' : '' ?> value="<?= date('Y')-2 ?>"><?= date('Y')-2 ?></option>
                                <option <?= $this->session->userdata('filterTahun') == date('Y') ? 'selected' : '' ?> value="<?= $this->session->userdata('filterTahun') == date('Y') ? $this->session->userdata('filterTahun') : date('Y') ?>"><?= $this->session->userdata('filterTahun') == date('Y') ? $this->session->userdata('filterTahun') : date('Y') ?></option>
